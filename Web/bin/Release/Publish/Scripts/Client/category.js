var categoryController = {
        ...
        $('.btnRegisBorrow').off('click').on('click', function () {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result) {
                        categoryController.regisBorrow(id);
                    }
                }
            });
        })
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (data.length > 0) {
                    ...
                    categoryController.showData(html, totalPages);
                    return;
                }

                categoryController.showData();
            },
            error: function () {
                categoryController.showData();
            }
    ...
    showData: function (html, totalPages) {
        ...
        categoryController.paging(totalPages ? totalPages : 1);
        categoryController.registerEvent();
        categoryController.getLink();
    },
